...
let analyser, dataArray, bufferLength, canvas, canvasCtx;
...
function draw() {
  ...
  canvasCtx.strokeStyle = '#5A8785';
  canvasCtx.stroke();
}

// bind to button
const waveBtn = document.getElementById('stream-play-btn');
if (waveBtn) {
  waveBtn.addEventListener('click', initWaveform, { once: true });
}
